      ...
      <CardContent className="pt-6 space-y-4">
        <div className="grid gap-4">
          ...
          <EncryptedField
            ...
            value={record.violationNotes || "No violations recorded"}
            isEncrypted={!!record.violationNotes}
          />

          <EncryptedField
            label="Documentation References"
            value={record.documentation || "No documentation attached"}
            isEncrypted={!!record.documentation}
          />
